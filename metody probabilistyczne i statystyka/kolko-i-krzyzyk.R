...
# wnioski:
# 1. Rozkład liczby zajętych pól bardzo przypomina rozkład
#    liczby posunięć w partiach. W każdym przypadku to rozkład
#    Poissona.
# 2. Prawdopodobieństwo wygranej gracza nr 1 jest małe - 0.3